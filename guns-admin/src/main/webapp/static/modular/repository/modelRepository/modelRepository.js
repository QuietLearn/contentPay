...
ModelRepository.initColumn = function () {
    return [
        {field: 'selectItem', radio: true},
            ...
            {title: '登录', field: 'userName', visible: true, align: 'center', valign: 'middle'},
            {title: '密码', field: 'password', visible: true, align: 'center', valign: 'middle'},
            {title: '', field: 'pwdMD5', visible: true, align: 'center', valign: 'middle'},
            ...
            {title: '是否开启私聊  1  开启 2 不开启', field: 'isChat', visible: true, align: 'center', valign: 'middle'},
